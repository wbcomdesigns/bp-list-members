 ...
 * @subpackage Bp_List_Members/admin
 */
...
class Bp_List_Members_Admin {
    ...
    public function enqueue_styles() {
        ...
        wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . 'css/bp-list-members-admin.css', array(), $this->version, 'all');
    }
    ...
    public function enqueue_scripts() {
         ...
         * class.
         */
        wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/bp-list-members-admin.js', array('jquery'), $this->version, false);
    }

    public function blm_admin_notice() {
